...
import 'package:vendedor/presentation/screens/home/widgets/ben2.dart';

import 'package:vendedor/widgets/add_minus_button.dart';

class Ben1 extends StatelessWidget {
  const Ben1({super.key});
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const Ben2()));
            },
            child: Column(
              children: [
                Container(
